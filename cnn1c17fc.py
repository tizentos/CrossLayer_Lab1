...
class SimpleNet (nn.Module):
	def __init__ (self, args):
		...
		#elf.features.add_module( "relu10", nn.ReLU())
		...
		self.lin2 = nn.Linear( 14 * 14 * 4 , 4096 )
		self.relu2 = nn.ReLU()
		...
		self.lin13 = nn.Linear( 4096 , 4096 )
		self.relu13 = nn.ReLU()

		self.lin14 = nn.Linear( 4096 , 4096 )
		self.relu14 = nn.ReLU()

		self.lin15 = nn.Linear( 4096 , 4096 )
		self.relu15 = nn.ReLU()

		self.lin16 = nn.Linear( 4096 , 4096 )
		self.relu16 = nn.ReLU()

		self.lin17 = nn.Linear( 4096 , 4096 )
		self.relu17 = nn.ReLU()

		self.lin18 = nn.Linear( 4096 , 4096 )
		self.relu18 = nn.ReLU()
